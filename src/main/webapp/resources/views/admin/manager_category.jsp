    ...
    <body>
        ...
        <jsp:include page="header.jsp"></jsp:include>
            ...
            <jsp:include page="menu.jsp"></jsp:include>
                <div id="rightContent">
                    <h3> Loại sản phẩm</h3>
                    <a href="${pageContext.request.contextPath}/admin/category/add">Thêm loại sản phẩm</a>                                   
                <table class="data">
                    <tr class="data">
                    ...
                    <c:forEach items="${cates}" var="c" varStatus="loop">
	                    ...
	                    <center>
	                        <a href="${pageContext.request.contextPath}/admin/update_category/${c.categoryID}/${c.categoryName}">Sửa</a>&nbsp;&nbsp; | &nbsp;&nbsp;
	                        <a href="${pageContext.request.contextPath}/admin/manager_category/delete/${c.categoryID}">Xóa</a>
	                    </center>
	                    </td>
	                    </tr>
                    </c:forEach>
