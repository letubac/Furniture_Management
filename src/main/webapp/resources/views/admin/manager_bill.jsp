    ...
    <body>
        ...
        <jsp:include page="header.jsp"></jsp:include>
                    ...
                    <c:forEach items="${bills}" var="b">
	                    <tr class="data">
	                        ...
	                        <td class="data" width="75px">
			                    <center>
								<a style="cursor: pointer;" title="hoàn tất" onclick=update(${b.id},3); ><span  style="color:green;font-size: 24px"> &#10004;</span> </a>&nbsp;&nbsp;
								<a style="cursor: pointer;" title="hủy dơn" onclick=update(${b.id},2); ><span  style="font-size:24px;color:red">&#x3A7;</span> </a>&nbsp;&nbsp;
								<a title="xóa đơn" href="${pageContext.request.contextPath}/admin/bill/delete/${b.id}"><span  style="font-size:24px">&#x26D4;</span></a> &nbsp;&nbsp;
			                    </center> 
		                    </td>
	                    </tr>
                    </c:forEach>
			...
			function update(id, stt){
				$.ajax({
					url : "${pageContext.request.contextPath}/admin/bill/update/" +id +'/' + stt,
					type : "GET",
					async : false,
					success : function(data) {
						if (data.mess === 'ok'){
							window.location.href = "${pageContext.request.contextPath}/admin/manager_bill"
						}
						if (data.mess === 'eq'){
