...
<body>
	...
	<div id="wrapper">
		...
		<div id="rightContent">
			...
			<form:form
				action="${pageContext.request.contextPath}/admin/manager_product_edit"
				method="post" id="test" modelAttribute="product_edit"
				...
				<table width="95%">
					<tr>
						<td>
							<b>Tên sản phẩm</b>
							<form:input type="hidden" class="sedang prodName" value="${product.productID}" path="prodId" />
						</td>
						<td>
					...
					<tr>
						<td>
							<b>Hình ảnh (Không chọn sẽ giữ lại hình ảnh cũ)</b>
						</td>
						<td>
