...
<body>
	<%
		...
		if (users == null) {
			response.sendRedirect("login");  //chỗ này á, là send về url, control return là return đường dẫn view, 2 cái khác nhau
		}
	%>
			...
			<table class="data">
				...
				<c:forEach items="${prods}" var="p" varStatus="loop">
					<tr class="data">
						...
						<td class="data">
							<img style="text-align: center" witdh="50px" height="50px"
						...
						<td class="data">
							<fmt:formatNumber value="${p.productBuy}" type="currency"
								currencySymbol="" />
							VNĐ
						</td>
						...
						<td class="data" width="90px">
							<center>
								<a
									href="${pageContext.request.contextPath}/admin/product/update_product/${p.productID}">Sửa</a>
								&nbsp;&nbsp; | &nbsp;&nbsp;
								<a
									href="${pageContext.request.contextPath}/admin/product/delete/${p.productID}">Xóa</a>
							</center>
						</td>
					</tr>
				</c:forEach>
