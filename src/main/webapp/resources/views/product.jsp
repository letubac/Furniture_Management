                        ...
                        <div class="categories animated wow slideInUp" data-wow-delay=".5s">
                            ...
                            <ul class="cate">
                            	<c:forEach items="${categories}" var="c">
                                     <li>
                                          <a href="${pageContext.request.contextPath}/single/product/${c.categoryID}">${c.categoryName} </a>
                                     </li>
                                </c:forEach>
                        </ul>
                    </div>                   
                ...
                <div class="col-md-8 products-right">
                    <div class="products-right-grid">
                        ...
                        <div class="products-right-grids-position animated wow slideInRight" data-wow-delay=".5s">
                            <img src="${pageContext.request.contextPath}/resources/images/slider3.jpg" alt=" " class="img-responsive" />
                                    ...
                                    <div class="new-collections-grid1 products-right-grid1 animated wow slideInUp animated" data-wow-delay=".5s">
                                        <div class="new-collections-grid1-image" style="width: 190.99px">
                                            <a href="${pageContext.request.contextPath}/single/${p.productID}" class="product-image">
                                                <img style="width: 190.99px" src="${pageContext.request.contextPath}/${p.productImage}" alt=" " class="img-responsive" />
                                            </a>
                                            <div class="new-collections-grid1-image-pos">
                                                <a href="${pageContext.request.contextPath}/single/${p.productID}" >Xem Nhanh</a>
                                            </div>
                                        ...
                                        <h4 style="font-size:16px"><a href="${pageContext.request.contextPath}/single/${p.productID}" >${p.productName}</a></h4>
