...
(function () {
  CKEDITOR.dialog.add('templates', function (c) {
    function r (a, b) {
      ...
      const b = CKEDITOR.dialog.getCurrent(); b.getValueOf('selectTpl', 'chkInsertOpt')
        ? (c.fire('saveSnapshot'), c.setData(a, function () {
...
'dialogs/templates.css')); let g; var h = 'cke_tpl_list_label_' + CKEDITOR.tools.getNextNumber(); const f = c.lang.templates; const n = c.config; return {
...
h + '"\x3e\x3cdiv class\x3d"cke_tpl_loading"\x3e\x3cspan\x3e\x3c/span\x3e\x3c/div\x3e\x3c/div\x3e\x3cspan class\x3d"cke_voice_label" id\x3d"' + h + '"\x3e' + f.options + '\x3c/span\x3e'
      ...
      onShow: function () {
        const a = this.getContentElement('selectTpl', 'templatesList'); g = a.getElement(); CKEDITOR.loadTemplates(n.templates_files, function () {
