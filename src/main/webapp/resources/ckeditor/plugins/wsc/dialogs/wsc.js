...
(function () {
  function z (a) { return a && a.domId && a.getInputElement().$ ? a.getInputElement() : a && a.$ ? a : !1 } function I (a) {
    if (!a) throw 'Languages-by-groups list are required for construct selectbox'; const c = []; let e = ''; let d; for (d in a) for (const f in a[d]) { const h = a[d][f]; h == 'en_US' ? e = h : c.push(h) }c.sort(); e && c.unshift(e); return {
      getCurrentLangGroup: function (c) { a: { for (const d in a) for (const e in a[d]) if (e.toUpperCase() === c.toUpperCase()) { c = d; break a }c = '' } return c },
...
e
    ...
    const a = function (a, b, d) { d = d || {}; let f = d.expires; if (typeof f === 'number' && f) { const h = new Date(); h.setTime(h.getTime() + 1E3 * f); f = d.expires = h }f && f.toUTCString && (d.expires = f.toUTCString()); b = encodeURIComponent(b); a = a + '\x3d' + b; for (const k in d)b = d[k], a += '; ' + k, !0 !== b && (a += '\x3d' + b); document.cookie = a }; return {
      postMessage: {
        ...
        send: function (a) {
          ...
          const d = a.fn || null; const f = a.id || ''; const h = a.target || window; let k = a.message || { id: f }; a.message && b.call(a.message) == '[object Object]' && (a.message.id ? a.message.id : a.message.id = f, k = a.message); a = window.JSON.stringify(k, d); h.postMessage(a, '*')
        },
      ...
      misc: {
        findFocusable: function (a) { let b = null; a && (b = a.find('a[href], area[href], input, select, textarea, button, *[tabindex], *[contenteditable]')); return b },
        isVisible: function (a) {
          let b; (b = a.offsetWidth === 0 || a.offsetHeight == 0) || (b = (document.defaultView && document.defaultView.getComputedStyle ? document.defaultView.getComputedStyle(a, null).display : a.currentStyle ? a.currentStyle.display : a.style.display) === 'none')
          return !b
        },
...
null; a.targetFromFrame = {}; a.onLoadOverlay = null; a.LocalizationComing = {}; a.OverlayPlace = null; a.sessionid = ''; a.LocalizationButton = {
  ...
  }; a.LocalizationLabel = { ChangeTo_label: { instance: null, text: 'Change to', localizationID: 'ChangeTo' }, Suggestions: { instance: null, text: 'Suggestions' }, Categories: { instance: null, text: 'Categories' }, Synonyms: { instance: null, text: 'Synonyms' } }; const J = function (b) {
    let c, e, d; for (d in b) {
...
c); let d = document.createDocumentFragment(); let f; let h; const k = []; if (e.options.length === 0) { for (f in b)k.push([f, b[f]]); k.sort(); for (let p = 0; p < k.length; p++)f = document.createElement('option'), f.setAttribute('value', k[p][1]), h = document.createTextNode(k[p][0]), f.appendChild(h), d.appendChild(f); e.appendChild(d) } for (d = 0; d < e.options.length; d++)e.options[d].value == a.selectingLang && (e.options[d].selected = 'selected')
...
a + ';opacity: ' + f + ';filter: alpha(opacity\x3d' + 100 * f + ');display: none;'; k.id = d; h || e.appendChild(k); return { setDisable: function () { k.style.display = 'none' }, setEnable: function () { k.style.display = 'block' } }
    ...
    const d = new CKEDITOR.dom.element('div'); const f = new CKEDITOR.dom.element('input'); const h = new CKEDITOR.dom.element('label'); const k = 'wscGrammerSuggest' + b + '_' + c; d.addClass('cke_dialog_ui_input_radio'); d.setAttribute('role', 'presentation'); d.setStyles({ width: '97%', padding: '5px', 'white-space': 'normal' }); f.setAttributes({
      type: 'radio',
      value: c,
  ...
  }; const F = function (a) { a = a || 'true'; a !== null && a == 'false' && t() }; const w = function (b) {
...
h; break
    ...
    settext: function (b) { delete b.id; a.dialog.getParentEditor().getCommand('checkspell'); const c = a.dialog.getParentEditor(); if (c.scayt && c.wsc.isSsrvSame) { const e = c.wsc.udn; e ? c.wsc.DataStorage.setData('scayt_user_dictionary_name', e) : c.wsc.DataStorage.setData('scayt_user_dictionary_name', '') } try { c.focus() } catch (d) {}c.setData(b.text, function () { a.dataTemp = ''; c.unlockSelection(); c.fire('saveSnapshot'); a.dialog.hide() }) },
...
b.currentLang; (b.cmd = b.len !== '0' && b.len) ? a.div_overlay.setDisable() : window.setTimeout(function () { try { a.div_overlay.setDisable() } catch (b) {} }, 500); J(a.LocalizationButton); K(a.LocalizationLabel)
    ...
    getOptions: function (b) {
      let c = b.DefOptions.udn; a.LocalizationComing =
b.DefOptions.localizationButtonsAndText; a.show_grammar = b.show_grammar; a.langList = b.lang; a.bnr = b.bannerId; a.sessionid = b.sessionid; if (b.bannerId) { a.setHeightBannerFrame(); var e = b.banner; a.dialog.getContentElement(a.dialog._.currentTabId, 'banner').getElement().setHtml(e) } else a.setHeightFrame(); c == 'undefined' && (a.userDictionaryName
        ? (c = a.userDictionaryName, e = { osp: g.cookie.get('osp'), udn: a.userDictionaryName, cust_dic_ids: a.cust_dic_ids, id: 'options_dic_send', udnCmd: 'create' }, g.postMessage.send({
            message: e,
  ...
  }; const G = function (a) { a = a || window.event; if ((a = window.JSON.parse(a.data)) && a.id)O[a.id](a) }; var E = function (b, c, e, d) {
    ...
    superset: { onShow: function () { a.dialog.showPage('Thesaurus'); a.dialog.showPage('GrammTab'); l() }, allowedTabCommands: { spell: !0, grammar: !0, thes: !0 }, defaultTabCommand: 'spell' },
    usual: { onShow: function () { x(); t(); l() }, allowedTabCommands: { spell: !0 }, defaultTabCommand: 'spell' },
    rtl: {
      onShow: function () { x(); t(); l() },
    ...
    spellthes: { onShow: function () { a.dialog.showPage('Thesaurus'); t(); l() }, allowedTabCommands: { spell: !0, thes: !0 }, defaultTabCommand: 'spell' }
  }; const H = function (b) { const c = (new function (a) { const b = {}; return { getCmdByTab: function (c) { for (const h in a)b[a[h]] = h; return b[c] } } }(a.cmd)).getCmdByTab(CKEDITOR.config.wsc_cmd); b.selectPage(c); a.sendData(b) }; var x = function () { a.dialog.hidePage('Thesaurus') }
  var t = function () { a.dialog.hidePage('GrammTab') }; var l = function () { a.dialog.showPage('SpellTab') }; var v = function () { const b = a.dialog.getContentElement(a.dialog._.currentTabId, 'bottomGroup').getElement(); b.removeStyle('display'); b.removeStyle('position'); b.removeStyle('left'); b.show() }; var N = function () {
    const b = a.dialog.getContentElement(a.dialog._.currentTabId, 'bottomGroup').getElement(); const c = document.activeElement; let e; b.setStyles({ display: 'block', position: 'absolute', left: '-9999px' }); setTimeout(function () {
    ...
    const c = document.activeElement; let e; b.setStyles({ display: 'block', position: 'absolute', left: '-9999px' }); setTimeout(function () { b.removeStyle('display'); b.removeStyle('position'); b.removeStyle('left'); b.hide(); a.dialog._.editor.focusManager.currentActive.focusNext(); e = g.misc.findFocusable(a.dialog.parts.contents); if (g.misc.hasClass(c, 'cke_dialog_tab') || g.misc.hasClass(c, 'cke_dialog_contents_body') || !g.misc.isVisible(c)) for (var d = 0, f; d < e.count(); d++) { if (f = e.getItem(d), g.misc.isVisible(f.$)) { try { f.$.focus() } catch (h) {} break } } else try { c.focus() } catch (k) {} },
      0)
      ...
      b.wsc = {}; (function (a) {
        const b = {
          ...
          restoreDataFromString: function (a) {
            let b = a; let c; a = this.backCompatibility(a); if (typeof a === 'string') {
...
'true'; break; case 'number':b = parseFloat(b); break; case 'array':b = b === '' ? [] : b.split(','); break; case 'null':b = null; break; case 'undefined':b = void 0
          ...
          backCompatibility: function (a) { let b = a; let c; typeof a === 'string' && (c = a.indexOf(this.separator), c < 0 && (b = parseFloat(a), isNaN(b) && (a[0] === '[' && a[a.length - 1] === ']' ? (a = a.replace('[', ''), a = a.replace(']', ''), b = a === '' ? [] : a.split(',')) : b = a === 'true' || a === 'false' ? a === 'true' : a), b = this.convertDataToString(b))); return b }
        }; const c = {
          get: function (a) { return b.restoreDataFromString(window.localStorage.getItem(a)) },
          set: function (a, c) { const d = b.convertDataToString(c); window.localStorage.setItem(a, d) },
          ...
          set: function (a, c) { const d = b.convertDataToString(c); this.setCookie(a, d, { expires: this.expiration }) },
          ...
          setCookie: function (a, b, c) { c = c || {}; let d = c.expires; if (typeof d === 'number' && d) { const e = new Date(); e.setTime(e.getTime() + 1E3 * d); d = c.expires = e }d && d.toUTCString && (c.expires = d.toUTCString()); b = encodeURIComponent(b); a = a + '\x3d' + b; for (const h in c)b = c[h], a += '; ' + h, !0 !== b && (a += '\x3d' + b); document.cookie = a },
          ...
          clear: function () {
            for (let a = document.cookie.split(';'), b = 0; b < a.length; b++) {
              ...
              var c = d > -1 ? c.substr(0, d) : c; this.deleteCookie(c)
            }
          }
        }; const e = window.localStorage ? c : d; a.DataStorage = { getData: function (a) { return e.get(a) }, setData: function (a, b) { e.set(a, b) }, deleteData: function (a) { e.del(a) }, clear: function () { e.clear() } }
      ...
      this.getElement().focus(); a.div_overlay.setEnable(); c = a.dialog._.currentTabId; const d = a.iframeNumber + '_' + c; const e = a.textNode[c].getValue(); const f = this.getElement().getAttribute('title-cmd'); g.postMessage.send({
        message: {
          cmd: f,
          tabId: c,
          new_word: e
        ...
        id: 'cmd_outer__page'
      }); f != 'ChangeTo' && f != 'ChangeAll' || b.fire('saveSnapshot'); f == 'FinishChecking' && b.config.wsc_onFinish.call(CKEDITOR.document.getWindow().getFrame())
      ...
      onShow: function () {
        ...
        a.TextAreaNumber = 'cke_textarea_' + b.name; g.postMessage.init(G); a.dataTemp = b.getData(); a.OverlayPlace = a.dialog.parts.tabs.getParent().$; if (CKEDITOR && CKEDITOR.config) {
          a.wsc_customerId = b.config.wsc_customerId; a.cust_dic_ids = b.config.wsc_customDictionaryIds; a.userDictionaryName = b.config.wsc_userDictionaryName; a.defaultLanguage = CKEDITOR.config.defaultLanguage; var d = document.location.protocol == 'file:' ? 'http:' : document.location.protocol; var d = b.config.wsc_customLoaderScript || d + '//loader.webspellchecker.net/sproxy_fck/sproxy.php?plugin\x3dfck2\x26customerid\x3d' +
a.wsc_customerId + '\x26cmd\x3dscript\x26doc\x3dwsc\x26schema\x3d22'; c(this); CKEDITOR.scriptLoader.load(d, function (c) {
            ...
            b.plugins.scayt && (b.wsc.isSsrvSame = (function () {
              ...
              const e = b.wsc.cgiOrigin(); b.wsc.syncIsDone = !1; c = function (a) {
                ...
                b.wsc.syncIsDone = !0))
              }; var h = function (c) { c = b.wsc.getLocalStorageUD(); let d; c instanceof Array && (d = c.toString()); void 0 !== d && d !== '' && setTimeout(function () { b.wsc.addWords(d, function () { H(a.dialog); a.dialog.setupContent(a.dialog) }) }, 400) }; window.addEventListener ? addEventListener('message', c, !1) : window.attachEvent('onmessage', c); setTimeout(function () { const a = b.wsc.getLocalStorageUDN(); void 0 !== a && b.wsc.operationWithUDN('restore', a) }, 500)
            }
          })
        } else a.dialog.hide()
      },
      onHide: function () {
        ...
        const d = b.scayt; b.unlockSelection(); c && d && c.state[b.name] && d.setMarkupPaused(!1); a.dataTemp = ''; a.sessionid = ''; g.postMessage.unbindHandler(G); if (b.plugins.scayt && b.wsc && b.wsc.isSsrvSame) {
          var c = b.wsc.udn; const e = b.wsc.ud; let f; let l; b.scayt
            ? (c ? (b.wsc.DataStorage.setData('scayt_user_dictionary_name', c), b.scayt.restoreUserDictionary(c)) : (b.wsc.DataStorage.setData('scayt_user_dictionary_name', ''), b.scayt.removeUserDictionary()), e && setTimeout(function () { f = e.split(','); for (l = 0; l < f.length; l += 1)b.scayt.addWordToUserDictionary(f[l]) },
                200), e || b.wsc.DataStorage.setData('scayt_user_dictionary', []))
            : (c ? b.wsc.DataStorage.setData('scayt_user_dictionary_name', c) : b.wsc.DataStorage.setData('scayt_user_dictionary_name', ''), e && (f = e.split(','), b.wsc.DataStorage.setData('scayt_user_dictionary', f)))
        }
      },
      contents: [{
        id: 'SpellTab',
          ...
          children: [{
            ...
            children: [{
              ...
              children: [{
                ...
                width: '140px',
                default: '',
                onShow: function () { a.textNode.SpellTab = this; a.LocalizationLabel.ChangeTo_label.instance = this },
            ...
            children: [{
              ...
              widths: ['50%', '50%',
                '50%', '50%'],
              children: [{ type: 'button', id: 'ChangeTo_button', label: a.LocalizationButton.ChangeTo_button.text, title: 'Change to', style: 'width: 100%;', onLoad: function () { this.getElement().setAttribute('title-cmd', 'ChangeTo'); a.LocalizationButton.ChangeTo_button.instance = this }, onClick: d }, {
                type: 'button',
                id: 'ChangeAll',
...
this
              ...
              widths: ['50%', '50%', '50%'],
              children: [{ type: 'button', id: 'IgnoreWord', label: a.LocalizationButton.IgnoreWord.text, title: 'Ignore word', style: 'width: 100%;', onLoad: function () { this.getElement().setAttribute('title-cmd', this.id); a.LocalizationButton.IgnoreWord.instance = this }, onClick: d }, {
                type: 'button',
                id: 'IgnoreAllWords',
          ...
          children: [{ type: 'hbox', id: 'leftCol', align: 'left', width: '70%', children: [{ type: 'vbox', id: 'rightCol1', setup: function () { this.getChild()[0].getElement().$.src = a.logotype; this.getChild()[0].getElement().getParent().setStyles({ 'text-align': 'center' }) }, children: [{ type: 'html', id: 'logo', html: '\x3cimg width\x3d"99" height\x3d"68" border\x3d"0" src\x3d"" title\x3d"WebSpellChecker.net" alt\x3d"WebSpellChecker.net" style\x3d"display: inline-block;"\x3e' }] }] },
            {
              ...
              children: [{
                ...
                children: [{
                  ...
                  onClick: function () {
                    this.getElement().focus(); document.location.protocol == 'file:'
        ...
        elements: [{ type: 'html', id: 'banner', label: 'banner', style: '', html: '\x3cdiv\x3e\x3c/div\x3e' }, {
          ...
          setup: function () {
            const b =
a.iframeNumber + '_' + a.dialog._.currentTabId; const c = document.getElementById(b); a.targetFromFrame[b] = c.contentWindow
          }
        }, {
          type: 'vbox',
          id: 'bottomGroup',
        ...
        label: 'Thesaurus',
        accessKey: 'T',
        elements: [{ type: 'html', id: 'banner', label: 'banner', style: '', html: '\x3cdiv\x3e\x3c/div\x3e' }, { type: 'html', id: 'Content', label: 'spellContent', html: '', setup: function () { const b = a.iframeNumber + '_' + a.dialog._.currentTabId; const c = document.getElementById(b); a.targetFromFrame[b] = c.contentWindow } }, {
          type: 'vbox',
          id: 'bottomGroup',
              ...
              children: [{
                ...
                children: [{
                  ...
                  children: [{
                    ...
                    default: '',
                    onClick: function () { d[this.id] = this.getValue() ? 1 : 0 }
                ...
                children: [{
                  ...
                  labelStyle: 'font: 12px/25px arial, sans-serif;',
                  default: '',
                  onLoad: function () { r = this; const b = a.userDictionaryName ? a.userDictionaryName : (g.cookie.get('udn'), this.getValue()); this.setValue(b) },
                  onShow: function () { r = this; const b = g.cookie.get('udn') ? g.cookie.get('udn') : this.getValue(); this.setValue(b); this.setLabel(a.LocalizationComing.DictionaryName) },
                  onHide: function () { this.reset() }
                }, {
                  type: 'hbox',
                  id: 'Options_buttons',
                  children: [{
                    ...
                    widths: ['50%', '50%'],
                    children: [{ type: 'button', id: 'rename', label: 'Rename', title: 'Rename', style: 'width: 100%;', onLoad: function () { this.getElement().setAttribute('title-cmd', this.id) }, onShow: function () { (this.getElement().getFirst() || this.getElement()).setText(a.LocalizationComing.Rename) }, onClick: b }, {
                      type: 'button',
                      id: 'delete',
                      label: 'Remove',
                      title: 'Remove',
